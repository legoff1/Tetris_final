...
void Client::recvData(uint8_t (&arr)[220])
{
    sf::Packet packetRecv;
    sf::IpAddress sender;
    unsigned short port;
...
void Client::sendData(const uint8_t (&arr)[220])
{
    sf::Packet packetSend;
...
void Client::sendDataInt(const int32_t data)
{
    sf::Packet packetSend;
    packetSend << data;
...
void Client::recvDataInt(int32_t& data)
{
    sf::Packet packetRecv;
    sf::IpAddress sender;
    unsigned short port;
